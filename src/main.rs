...
fn main() {
    ...
    match day.as_str() {
        ...
        "14" => {
            ...
            println!("{}. desember, del 2: {}", day.as_str(), december_14::part_2(&input));
        }
        "15" => {
            println!("{}. desember, del 1: {}", day.as_str(), december_15::part_1(&input, 2000000));
            println!("{}. desember, del 2: {}", day.as_str(), december_15::part_2(&input, 4000000));
        }
        _ => ()
    }
}
